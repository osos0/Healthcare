      ...
      <div className={`container ${HeaderStyle.mainHeader}`}>
        <div className={`row`}>
          ...
          >
            ...
            <Image src={CrossImg} />
            <Image src={squareimg} className={HeaderStyle.square} />
            <Image src={ballon} className={HeaderStyle.balon} />
          </div>
          <div
            className={`col-lg-5 col-md-5 col-sm-12 ${HeaderStyle.RigthHeader}`}
          >
            <Image src={DoctoreImg} className={HeaderStyle.Doctore} />
            <Image src={zigzag} className={HeaderStyle.zigzag} />
